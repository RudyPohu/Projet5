    ...
    <div class="md:flex">
        <div class="md:w-6/12 p-8 m-4 bg-green-400 border-2 border-solid rounded-lg border-green-600">
            ...
            <form action="index.php?action=Entry" method="post">
                ...
                <input class="block m-auto w-64 border-2 border-solid rounded-lg border-green-600  p-1 m-4" type="text" name="login" >
                <br />
                <h2 class="text-center mb-4">Votre mot de passe:</h2> 
                <input class="block m-auto w-64 border-2 border-solid rounded-lg border-green-600  p-1 m-4" type="password" name="pass" >
                <br />
